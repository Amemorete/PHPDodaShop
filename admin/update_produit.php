    ...
    <div class="card shadow mt-4">
        ...
        <form  method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row input-group input-group-default">
                                    ...
                                    <input type="file" name="image1" value="<?php echo $row['photo1']; ?>"    class="form-control m-4 col-6 mb-4 ">
                                   
                    
                                </div>
                                <div class="row input-group input-group-default">
                    
                                    <input type="file" name="image2" value="<?php echo $row['photo2']; ?>"    class="form-control m-4 col-4 mb-4 ">
                                    <input type="file" name="image3" value="<?php echo $row['photo3']; ?>"    class="form-control m-4 col-4 mb-4 ">
                                    <input type="file" name="image4" value="<?php echo $row['photo4']; ?>"    class="form-control m-4 col-4 mb-4 ">
                                ...
                                <button type="submit" class="btn btn-success col-3" name="up_produit_info"> Modifier</button>
